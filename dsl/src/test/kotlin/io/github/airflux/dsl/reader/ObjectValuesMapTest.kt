        ...
        "The ObjectValuesMap" - {
            ...
            "when not added any value" - {
                ...
                "for required property" - {
                    val property = JsReaderProperty.Required(required(PROPERTY_NAME, StringReader))
                ...
                "for defaultable property" - {
                    val property =
                        JsReaderProperty.Defaultable(defaultable(PROPERTY_NAME, StringReader, PROPERTY_DEFAULT))
                ...
                "for optional property" - {
                    val property = JsReaderProperty.Optional(optional(PROPERTY_NAME, StringReader))
                ...
                "for optional with default property" - {
                    val property = JsReaderProperty.OptionalWithDefault(
                ...
                "for nullable property" - {
                    val property = JsReaderProperty.Nullable(nullable(PROPERTY_NAME, StringReader))
                ...
                "for nullable with default property" - {
                    val property = JsReaderProperty.NullableWithDefault(
            ...
            "when the added value is not null" - {
                ...
                "for required property" - {
                    ...
                    "then for unknown property" - {
                        val unknownProperty = JsReaderProperty.Required(required(UNKNOWN_PROPERTY_NAME, StringReader))
                ...
                "for defaultable property" - {
                    ...
                    "then for unknown property" - {
                        val unknownProperty = JsReaderProperty.Defaultable(
                ...
                "for optional property" - {
                    ...
                    "then for unknown property" - {
                        val unknownProperty = JsReaderProperty.Optional(optional(UNKNOWN_PROPERTY_NAME, StringReader))
                ...
                "for optional with default property" - {
                    ...
                    "then for unknown property" - {
                        val unknownProperty = JsReaderProperty.OptionalWithDefault(
                ...
                "for nullable property" - {
                    ...
                    "then for unknown property" - {
                        val unknownProperty = JsReaderProperty.Nullable(nullable(UNKNOWN_PROPERTY_NAME, StringReader))
                ...
                "for nullable with default property" - {
                    ...
                    "then for unknown property" - {
                        val unknownProperty = JsReaderProperty.NullableWithDefault(
