...
internal class ExceptionHandlersContainerTest : FreeSpec() {
    ...
    companion object {
        private val specificExceptionHandler =
            { _: JsReaderEnv<Unit, Unit>, _: JsLocation, _: IllegalArgumentException -> JsonErrors.PathMissing }

        private val genericExceptionHandler =
            { _: JsReaderEnv<Unit, Unit>, _: JsLocation, _: Exception -> JsonErrors.PathMissing }
    }
