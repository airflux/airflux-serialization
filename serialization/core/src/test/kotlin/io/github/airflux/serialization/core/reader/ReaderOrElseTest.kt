...
internal class ReaderOrElseTest : FreeSpec() {

    init {
        "The extension-function orElse for the JsReader type" - {
            ...
            "when left reader returns an value" - {
                ...
                val reader = leftReader orElse rightReader
            ...
            "when left reader returns an error" - {
                ...
                "when the right reader returns an error" - {
                    ...
                    "then an error of the right reader should be returned" {
                        val result = reader.read(ENV, LOCATION, JsNull)
