...
internal class StructOptionalPropertyTest : FreeSpec() {
    ...
    init {
        ...
        "The StructProperty#Optional type" - {
    ...
    private fun <CTX, T : Any, P : Any> createProperty(
        ...
        StructProperty.Optional(
            StructPropertySpec.Optional(name = PROPERTY_NAME, from = from, writer = writer)
        )
}
