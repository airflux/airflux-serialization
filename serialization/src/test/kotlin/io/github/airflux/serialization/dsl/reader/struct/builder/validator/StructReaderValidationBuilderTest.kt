...
internal class StructReaderValidationBuilderTest : FreeSpec() {

    companion object {
        private val firstValidatorBuilder = DummyStructValidatorBuilder<Unit, Unit>(
            key = DummyStructValidatorBuilder.key<Unit, Unit, DummyStructValidatorBuilder<Unit, Unit>>(),
            result = null
        )
        private val secondValidatorBuilder = DummyStructValidatorBuilder<Unit, Unit>(
            key = DummyStructValidatorBuilder.key<Unit, Unit, DummyStructValidatorBuilder<Unit, Unit>>(),
            result = null
        )
    }
    ...
    init {
        ...
        "The StructReaderValidation#Builder type" - {

            "when the builder is created" - {

                "then the builder should return the empty collection" {
                    val builder = StructReaderValidation.Builder<Unit, Unit>()
            ...
            "when the builder does not contain any item" - {
                ...
                "when some item is added" - {
                    val builder = StructReaderValidation.Builder<Unit, Unit>().apply {
