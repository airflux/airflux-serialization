...
internal class ObjectReaderValidationBuilderTest : FreeSpec() {

    companion object {
        private val firstValidatorBuilder = DummyObjectValidatorBuilder<Unit, Unit>(
            key = DummyObjectValidatorBuilder.key<Unit, Unit, DummyObjectValidatorBuilder<Unit, Unit>>(),
            result = null
        )
        private val secondValidatorBuilder = DummyObjectValidatorBuilder<Unit, Unit>(
            key = DummyObjectValidatorBuilder.key<Unit, Unit, DummyObjectValidatorBuilder<Unit, Unit>>(),
            result = null
        )
    }
    ...
    init {
        ...
        "The ObjectReaderValidation#Builder type" - {

            "when the builder is created" - {

                "then the builder should return the empty collection" {
                    val builder = ObjectReaderValidation.Builder<Unit, Unit>()
            ...
            "when the builder does not contain any item" - {
                ...
                "when some item is added" - {
                    val builder = ObjectReaderValidation.Builder<Unit, Unit>().apply {
