...
public class ReaderContext private constructor(
    ...
    internal companion object {
        ...
        operator fun invoke(): ReaderContext = ReaderContext(emptyMap())

        operator fun <E : Context.Element> invoke(element: E): ReaderContext =
            ReaderContext(mapOf(element.key to element))

        operator fun <E : Context.Element> invoke(elements: Iterable<E>): ReaderContext =
            ReaderContext(elements.associateBy { it.key })
    }
}
