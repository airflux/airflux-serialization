...
public class MaxPropertiesObjectValidator<EB, CTX> internal constructor(private val value: Int) :
    ...
    override fun validate(
        ...
        if (source.count > value)
            ReaderResult.Failure(location, env.errorBuilders.maxPropertiesObjectError(value, source.count))
        else
            null

    public interface ErrorBuilder {
        public fun maxPropertiesObjectError(expected: Int, actual: Int): ReaderResult.Error
    }
}
