...
public object ComparableValidator {
     ...
     */
    public fun <T> min(value: T): JsValidator<T>
        where T : Number,
     ...
     */
    public fun <T> max(value: T): JsValidator<T>
        where T : Number,
     ...
     */
    public fun <T> eq(value: T): JsValidator<T>
        where T : Number,
     ...
     */
    public fun <T> ne(value: T): JsValidator<T>
        where T : Number,
     ...
     */
    public fun <T> gt(value: T): JsValidator<T>
        where T : Number,
     ...
     */
    public fun <T> ge(value: T): JsValidator<T>
        where T : Number,
     ...
     */
    public fun <T> lt(value: T): JsValidator<T>
        where T : Number,
     ...
     */
    public fun <T> le(value: T): JsValidator<T>
        where T : Number,
