...
public class IsNotBlankStringValidator<EB, O> internal constructor() : JsValidator<EB, O, String?>
    ...
    override fun validate(
        ...
        location: JsLocation,
        value: String?
    ): JsValidatorResult = if (value != null) {
        if (value.isNotBlank())
            valid()
        else
    ...
    public fun interface ErrorBuilder {
        public fun isNotBlankStringError(): JsReaderResult.Error
    }
}
