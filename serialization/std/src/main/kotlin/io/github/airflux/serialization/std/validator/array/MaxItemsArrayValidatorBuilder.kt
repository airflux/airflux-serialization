...
internal class MaxItemsArrayValidatorBuilder<EB, O>(private val value: Int) : JsArrayValidator.Builder<EB, O>
    where EB : MaxItemsArrayValidator.ErrorBuilder {

    override fun build(): JsArrayValidator<EB, O> = MaxItemsArrayValidator(value)
}
