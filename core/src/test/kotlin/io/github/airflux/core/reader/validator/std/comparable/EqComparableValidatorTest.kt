        ...
        "The string validator Eq" - {
            ...
            "when the reader context does not contain the error builder" - {
                ...
                "when the test condition is false" {
                    ...
                    exception.message shouldBe "Key '${EqComparableValidator.ErrorBuilder.Key.name}' is missing in the JsReaderContext."
                }
            }
                ...
                "when a value is less than the allowed value" - {
                    ...
                    "then the validator should return an error" {
                        ...
                        errors.items shouldContainExactly listOf(
                            JsonErrors.Validation.Numbers.Eq(expected = VALUE, actual = value)
                        )
                    }
                }
