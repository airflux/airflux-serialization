...
internal class JsWriterContextTest : FreeSpec() {
    ...
    init {
        ...
        "The JsWriterContext" - {
            ...
            "when calling the constructor" - {
                ...
                "with one parameters" - {
                    val one = JsWriterContext(userContext)
                ...
                "with the collection of the parameters" - {
                    ...
                    val one = JsWriterContext(elements)
            ...
            "when context is empty" - {
                ...
                "the function getValue should throw exception by any key" {
                    ...
                    exception.message shouldBe "Key '${OrderContext.contextKeyName()}' is missing in the context of writing."
                }
    ...
    class UserContext : JsWriterAbstractContextElement<UserContext>(Key) {
        companion object Key : JsWriterContext.Key<UserContext> {
    ...
    class OrderContext : JsWriterAbstractContextElement<OrderContext>(Key) {
        companion object Key : JsWriterContext.Key<OrderContext> {
            override val name: String = contextKeyName()
        }
