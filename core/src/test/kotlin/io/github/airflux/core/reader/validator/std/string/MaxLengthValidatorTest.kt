        ...
        "The string validator MaxLength" - {
            ...
            "when the reader context does not contain the error builder" - {
                ...
                "when the test condition is false" {
                    ...
                    exception.message shouldBe "Key '${MaxLengthStringValidator.ErrorBuilder.Key.name}' is missing in the JsReaderContext."
                }
            }
                    ...
                    "when the length of the string is more the max allowed length" - {
                        ...
                        "then the validator should return an error" {
                            ...
                            errors.items shouldContainExactly listOf(
                                JsonErrors.Validation.Strings.MaxLength(
                                    expected = MAX_VALUE,
                                    actual = str.length
                                )
                            )
