        ...
        "The string validator Gt" - {
            ...
            "when the reader context does not contain the error builder" - {
                ...
                "when the test condition is false" {
                    ...
                    exception.message shouldBe "Key '${LtComparableValidator.ErrorBuilder.Key.name}' is missing in the JsReaderContext."
                }
            }
                ...
                "when a value is equal to the allowed value" - {
                    ...
                    "then the validator should return an error" {
                        ...
                        errors.items shouldContainExactly listOf(
                            JsonErrors.Validation.Numbers.Lt(expected = VALUE, actual = value)
                        )
                    }
                }
