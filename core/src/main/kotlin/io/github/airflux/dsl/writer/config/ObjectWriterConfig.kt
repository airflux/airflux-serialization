...
package io.github.airflux.dsl.writer.config
...
public class ObjectWriterConfig private constructor(
    ...
    @AirfluxMarker
    public class Builder internal constructor(base: ObjectWriterConfig) {
    ...
    public companion object {
        public val Default: ObjectWriterConfig = ObjectWriterConfig(
        ...
        public fun build(block: Builder.() -> Unit): ObjectWriterConfig = Builder(Default).apply(block).build()
    }
}
