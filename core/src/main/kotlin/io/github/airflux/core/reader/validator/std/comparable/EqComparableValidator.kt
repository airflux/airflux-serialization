...
public class EqComparableValidator<T> internal constructor(private val expected: T) : JsValidator<T>
    where T : Number,
          T : Comparable<T> {
    ...
    public class ErrorBuilder(private val function: (expected: Number, actual: Number) -> JsError) :
        ...
        public companion object Key : JsReaderContext.Key<ErrorBuilder> {
            override val name: String = "EqComparableValidatorErrorBuilder"
        }
    }
}
