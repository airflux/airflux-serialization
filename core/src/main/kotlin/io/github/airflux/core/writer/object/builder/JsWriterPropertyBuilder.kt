...
package io.github.airflux.core.writer.`object`.builder
...
import io.github.airflux.core.writer.writeAsNullable
import io.github.airflux.core.writer.writeAsOptional
import io.github.airflux.core.writer.writeAsRequired
import io.github.airflux.dsl.writer.config.ObjectWriterConfig

internal interface JsWriterPropertyBuilder<T> {

    val name: String
    fun buildConverter(configuration: ObjectWriterConfig): (T) -> JsValue?
    ...
    class Required<T, P : Any>(
        ...
        override fun buildConverter(configuration: ObjectWriterConfig): (T) -> JsValue? = { value: T ->
    ...
    class Optional {
        internal class Simple<T, P : Any>(
            ...
            override fun buildConverter(configuration: ObjectWriterConfig): (T) -> JsValue? =
