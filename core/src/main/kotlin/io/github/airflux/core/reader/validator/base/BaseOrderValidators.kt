...
@Suppress("unused")
public object BaseOrderValidators {

    /**
     * Validation of a value, if a value less than a [expected] value then [error], otherwise success.
     */
    public fun <T> min(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
     ...
     */
    public fun <T> max(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value > expected) JsErrors.of(error(expected, value)) else null
        }
     ...
     */
    public fun <T> eq(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
     ...
     */
    public fun <T> ne(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value != expected) null else JsErrors.of(error(expected, value))
        }
     ...
     */
    public fun <T> gt(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value > expected) null else JsErrors.of(error(expected, value))
        }
     ...
     */
    public fun <T> ge(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value >= expected) null else JsErrors.of(error(expected, value))
        }
     ...
     */
    public fun <T> lt(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value < expected) null else JsErrors.of(error(expected, value))
        }
     ...
     */
    public fun <T> le(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value <= expected) null else JsErrors.of(error(expected, value))
        }
