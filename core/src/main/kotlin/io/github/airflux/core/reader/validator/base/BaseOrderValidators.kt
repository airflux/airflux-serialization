...
object BaseOrderValidators {
     ...
     */
    fun <T> min(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
     ...
     */
    fun <T> max(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value > expected) JsErrors.of(error(expected, value)) else null
        }
     ...
     */
    fun <T> eq(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
     ...
     */
    fun <T> ne(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value != expected) null else JsErrors.of(error(expected, value))
        }
     ...
     */
    fun <T> gt(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value > expected) null else JsErrors.of(error(expected, value))
        }
     ...
     */
    fun <T> ge(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value >= expected) null else JsErrors.of(error(expected, value))
        }
     ...
     */
    fun <T> lt(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value < expected) null else JsErrors.of(error(expected, value))
        }
     ...
     */
    fun <T> le(expected: T, error: (expected: T, actual: T) -> JsError): JsValidator<T>
        where T : Comparable<T> =
        JsValidator { _, _, value ->
            if (value <= expected) null else JsErrors.of(error(expected, value))
        }
